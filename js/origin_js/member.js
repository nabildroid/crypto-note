class Member{
	...
	// عدم تواجد قاعدة بيانات مركزية ومخفية عن كل الزوار بل قاعدة بياناته متاحة لكل الزوار ولاكن بشكل مشفر 
	// ويكون التشفير فريد من نوعه من مستخدم لاخر  في نفس قاعدة البيانات وهاذا عن طريق استعمال كلمة المرور الحساب في عملية تشفيير وبهاذا فان ما يخزن في 
	// قاعدة البيانات هو اسم المتخدم فقط 
	// يمكن اظافة تنسيقات لملاحظاتك عن طريق البدء برموز معينة وهذه لائحة بالتنسيقات
	// ##هاشتاج_بشكل_مذهل
	// '\'نص غليض\'\'' و هذا عادي 
	...
	// او الضغط مرتين لتعديل العنوان ايضا كما ان حدث وكتبت ملاحظة تحتوي اكثر من 40 حرف  وبالخطء قمت بتحديث الموقع او الخروج منه 
	// فلا تقلق فعند زيارتك للموقع مجددا ستجدها بانتظارك 
	// اذن مذا تنتظر هيا جرب كل تلك الخصائص وستمتع`;
	// 	return [title,text,"yellow",new Date()];
	// }
}